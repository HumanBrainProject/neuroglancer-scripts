...
release = neuroglancer_scripts.__version__
...
htmlhelp_basename = 'neuroglancer-scriptsdoc'
...
man_pages = [
    (master_doc, 'neuroglancer-scripts', 'neuroglancer-scripts Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'neuroglancer-scripts', 'neuroglancer-scripts Documentation',
     author, 'neuroglancer-scripts', 'One line description of project.',
     'Miscellaneous'),
]
